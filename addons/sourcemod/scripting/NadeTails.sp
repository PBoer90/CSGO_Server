...
public OnPluginStart()
{
	...
	//CVARs
	g_Enabled 				= CreateConVar("sm_tails_enabled", "0", "Enables Nade Tails (0/1).", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	g_DefaultAlpha		= CreateConVar("sm_tails_defaultalpha", "120", "Default alpha for trails (0 is invisible, 255 is solid).", FCVAR_PLUGIN, true, 0.0, true, 255.0);
